...
\JAMTIdentifiers{UDC: \JAMTMissing{Insert the UDC index}}{DOI: \JAMTMissing{Insert the assigned DOI}}
...
\JAMTParagraph[language=russian]{body}{Замените примеры содержимым рукописи. Шрифт, отступы и интервалы задаются общим профилем. Недостающие сведения предоставляет автор или редакция.}
...
% Keep the heading with the first entry; add further entries after this box.
