...
class TemplateJob(models.Model):
    KIND_CHOICES = [("v1", "Legacy template workspace"), ("v2", "Word-first forensics"), ("jamt", "Стиль JAMT")]
    ...
    template = models.FileField(upload_to=job_upload, max_length=500, blank=True)
