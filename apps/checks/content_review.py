...
def _build_prompt(submission, document_text):
    ...
    return "\n".join(
        [
            ...
            "Материал может быть на английском или другом языке, но overall_assessment, title, explanation и recommendation всегда пиши по-русски.",
            "Поле quote оставляй на языке исходного документа, потому что это точная цитата.",
            ...
            "parts": [
                {
                    "text": (
                        ...
                        "Не выноси юридических вердиктов, не додумывай отсутствующие факты, "
                        "все пояснения пиши по-русски и отвечай только JSON."
                    )
                }
            ]
        },
