...
def build_interpretation_prompt(*, document_type: str, target_name: str, text: str) -> str:
    ...
    return (
        ...
        "7. Документ и требования могут быть на любом языке, но все поясняющие поля, "
        "названия правил и заметки в ответе пиши по-русски. Исходные названия разделов "
        "сохраняй без перевода только там, где они являются буквальным требованием.\n\n"
