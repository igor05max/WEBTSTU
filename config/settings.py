...
LATEXMK_BINARY = os.getenv("LATEXMK_BINARY", "").strip()
PDFLATEX_BINARY = os.getenv("PDFLATEX_BINARY", "").strip()
LATEX_COMPILE_TIMEOUT_SECONDS = max(
    10,
    int(os.getenv("LATEX_COMPILE_TIMEOUT_SECONDS", "90")),
)
SUBMISSION_LATEX_ARCHIVE_MAX_SIZE = int(
    os.getenv("SUBMISSION_LATEX_ARCHIVE_MAX_SIZE", str(100 * 1024 * 1024))
)
...
TEMPLATE_V2_VISUAL_REVIEW_ENABLED = os.getenv("TEMPLATE_V2_VISUAL_REVIEW_ENABLED", "0") == "1"
TEMPLATE_V2_VISUAL_REVIEW_MAX_PAGES = int(os.getenv("TEMPLATE_V2_VISUAL_REVIEW_MAX_PAGES", "8"))
...
JAMT_LATEX_EXPORT_ENABLED = os.getenv('JAMT_LATEX_EXPORT_ENABLED', '0') == '1'
JAMT_EDITORIAL_REVIEW_SECONDS = max(0, int(os.getenv('JAMT_EDITORIAL_REVIEW_SECONDS', '120')))
...
TEMPLATE_V2_QWEN_TIMEOUT = int(
    os.getenv("TEMPLATE_V2_QWEN_TIMEOUT", "300")
)
...
CITATION_MIN_RECOMMENDATION_PERCENT = int(
    os.getenv("CITATION_MIN_RECOMMENDATION_PERCENT", "21")
)
...
SUBMISSION_DOCUMENT_EXTRACTION_AI_ENABLED = os.getenv(
    "SUBMISSION_DOCUMENT_EXTRACTION_AI_ENABLED",
    "0",
) == "1"
SUBMISSION_DOCUMENT_EXTRACTION_MODEL = os.getenv(
    "SUBMISSION_DOCUMENT_EXTRACTION_MODEL",
    AI_MODEL,
)
SUBMISSION_DOCUMENT_EXTRACTION_TIMEOUT = int(
    os.getenv("SUBMISSION_DOCUMENT_EXTRACTION_TIMEOUT", str(AI_REQUEST_TIMEOUT))
)
